...
export const [state, setState] = createStore({
  fields: {
    pizza_num:
      query.get("pizza_num") ||
      localStorage.getItem("pizza_num_field") ||
      DEFAULT_VALUES["pizza_num"],
    weight:
      query.get("weight") ||
      localStorage.getItem("weight_field") ||
      DEFAULT_VALUES["weight"],
    hydration:
      query.get("hydration") ||
      localStorage.getItem("hydration_field") ||
      DEFAULT_VALUES["hydration"],
    salt:
      query.get("salt") ||
      localStorage.getItem("salt_field") ||
      DEFAULT_VALUES["salt"],
  } as Recipe,
  get ingredients() {
